...
class TokenInfo:
    ...
    async def get_token_info(token_mint_address):
        ...
        # url = f"https://gmgn.ai/api/v1/mutil_window_token_link_rug_vote/sol/{token_mint_address}"
    ...
    def convert_price_to_string(price):
        ...
        if zero_count > 2:
            ...
            converted_price = price_str[:dot_position+2] + "{" + str(
                zero_count-1) + "}" + price_str[dot_position+1+zero_count:]
        else:
